...
# Transformer implementation of "Truth of Varying Shades: Analyzing Language in Fake News and Political Fact-Checking"
...
# Tested with including the speaker for each statement, but that showed no significant difference.
